...
#
package Optikus::Canvas::Widget::Control;

use strict;
use Gtk2;

use Optikus::Canvas::Widget::Control::Runner;
use Optikus::Canvas::Widget::Control::Offnominal;
use Optikus::Canvas::Widget::Control::Link;
