...
#  $Source$
#
#  Utilities for the Optikus data widget library.
#
package Optikus::Canvas::Util;
...
our ($root_home, $pic_home, $scr_home, $etc_home);
...
$root_home = $ENV{OPTIKUS_HOME};
$pic_home = "$root_home/share/pic";
$scr_home = "$root_home/share/screens";
$etc_home = "$root_home/etc";

my $debug = 0;

sub pforms_log_file
{
  my $log_home = "$root_home/var/log";
...
sub pforms_gtk_init
{
  ...
  Gtk2->init;
  my $theme_home = "$root_home/share/themes";
  my $gtkrc;
