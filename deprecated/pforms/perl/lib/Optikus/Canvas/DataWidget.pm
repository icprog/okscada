...
#
package Optikus::Canvas::DataWidget;

use strict;

use Optikus::Canvas::Widget::Toggle;
use Optikus::Canvas::Widget::Range;
use Optikus::Canvas::Widget::String;
use Optikus::Canvas::Widget::MultiString;
use Optikus::Canvas::Widget::LED;
use Optikus::Canvas::Widget::Meter;
use Optikus::Canvas::Widget::ManoMeter;
use Optikus::Canvas::Widget::Anim;
